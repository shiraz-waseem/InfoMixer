...
import { faQuoteLeft, faQuoteRight, faVolumeHigh, faCopy } from '@fortawesome/free-solid-svg-icons';
...
const Randomquotes = () => {
    ...
    useEffect(() => {
        if (!hasEffectRun.current) { // Check if the effect has already run
            fetchRandomQuote();
            console.log("Hey");
                    ...
                    <div className="wrapper">
                            ...
                            {quoteData ? (
                                <>
                                    <div className='quote-area'>
                                        ...
                                        <p id='quotes' className='quote'>{quoteData.text}</p>
                                        <i> <FontAwesomeIcon icon={faQuoteRight} /></i>
                                    </div>
                                    <div className="author">
                                        <span>__</span>
                                        <p id='author' className='name'>{quoteData.author}</p>
                                    </div>
                                </>
                            ) : (
                                "Loading...."
                        ...
                        <div className="buttons">
                            <div className="features">
                                <ul>
                                    <li class="speech" onClick={handleSpeech}><i><FontAwesomeIcon icon={faVolumeHigh} style={{ color: "#4185fb", }} /></i></li>
                                    <li class="copy" onClick={handleCopyClick}><i><FontAwesomeIcon icon={faCopy} style={{ color: isCopied ? "green" : "#4185fb" }} /></i></li>
                                    <li class="twitter" onClick={handleTwitterClick}><i><FontAwesomeIcon icon={faTwitter} style={{ color: "#4185fb", }} /></i></li>
                                </ul>

                                <button id="jokebtn" className="button" onClick={fetchRandomQuote}>
                                    <p id='newQ'>
                                        Next Quote
                                    </p>
                                </button>
